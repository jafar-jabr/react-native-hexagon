...
public class HexagonImageSource extends ImageSource {
    ...
    public HexagonImageSource(Context context, String source) {
        this(context, source, null);
    }

    public HexagonImageSource(Context context, String source, @Nullable Headers headers) {
        this(context, source, 0.0d, 0.0d, headers);
    }

    public HexagonImageSource(Context context, String source, double width, double height, @Nullable Headers headers) {
    ...
    public boolean isBase64Resource() {
        return mUri != null && HexagonImageSource.isBase64Uri(mUri);
    }

    public boolean isResource() {
        return mUri != null && HexagonImageSource.isResourceUri(mUri);
    }

    public boolean isLocalFile() {
        return mUri != null && HexagonImageSource.isLocalFileUri(mUri);
    }

    public boolean isContentUri() {
        return mUri != null && HexagonImageSource.isContentUri(mUri);
    }
