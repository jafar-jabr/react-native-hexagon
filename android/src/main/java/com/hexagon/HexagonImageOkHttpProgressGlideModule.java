...
@GlideModule
public class HexagonImageOkHttpProgressGlideModule extends LibraryGlideModule {
    ...
    static void expect(String key, HexagonImageProgressListener listener) {
    ...
    private static class DispatchingProgressListener implements ResponseProgressListener {
        private final Map<String, HexagonImageProgressListener> LISTENERS = new WeakHashMap<>();
        ...
        void expect(String key, HexagonImageProgressListener listener) {
            LISTENERS.put(key, listener);
        }

        @Override
        public void update(final String key, final long bytesRead, final long contentLength) {
            final HexagonImageProgressListener listener = LISTENERS.get(key);
            if (listener == null) {
                return;
            }
